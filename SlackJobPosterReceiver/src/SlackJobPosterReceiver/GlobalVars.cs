...
namespace SlackJobPosterReceiver
{
    public static class GlobalVars
    {
        ...
        public static string SLACK_TOKEN = Environment.GetEnvironmentVariable("SLACK_TOKEN");
        public static readonly string CLOSE_TOKEN = Environment.GetEnvironmentVariable("CLOSE_TOKEN");
        public static string SLACK_VERIFICATION_TOKEN = Environment.GetEnvironmentVariable("SLACK_VERIFICATION_TOKEN");
